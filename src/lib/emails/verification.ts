...
/**
 * Dark-themed, responsive HTML email for email verification.
...
<head>
  ...
  <title>Verificação de e-mail — Momentos</title>
  <!--[if mso]>
  <style>
...
<body style="margin:0; padding:0; background-color:#030303; font-family:'Geist','Inter',system-ui,-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;">
  ...
  <div style="display:none; max-height:0; overflow:hidden; mso-hide:all;">
    Confirma o teu e-mail para ativares a tua conta Momentos.
  </div>
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td align="center" style="padding-bottom:24px;">
                    <div style="display:inline-block; width:56px; height:56px; line-height:56px; text-align:center; border-radius:50%; background-color:rgba(59,130,246,0.1);">
                ...
                <tr>
                  <td align="center" style="padding-bottom:32px;">
                    <p style="margin:0; font-size:14px; line-height:1.6; color:rgba(255,255,255,0.6); max-width:360px;">
                      Obrigado por criares conta na <strong style="color:rgba(255,255,255,0.8);">Momentos</strong>. Clica no botão abaixo para confirmar o teu endereço de e-mail e ativar a tua conta.
                    </p>
                  </td>
                </tr>
              </table>
          ...
          <tr>
            <td align="center" style="padding-top:32px;">
              <p style="margin:0; font-size:12px; color:rgba(255,255,255,0.25); line-height:1.5;">
                Se não criaste conta na Momentos, podes ignorar este e-mail.
              </p>
