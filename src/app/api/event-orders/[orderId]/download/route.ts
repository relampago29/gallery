...
/** GET /api/event-orders/[orderId]/download — redireciona para Cloud Function */
export async function GET(req: Request, { params }: RouteParams) {
  try {
    ...
    const redirectUrl = `${fnOrigin}/downloadEventOrder?orderId=${encodeURIComponent(
      orderId
    ...
    console.error("[event-order-download] unexpected error", err);
    return NextResponse.json(
